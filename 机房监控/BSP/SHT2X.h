...
#define SHT2X_SCK_PIN      					 	  GPIO_Pin_10   
#define SHT2X_SCK_GPIO_PORT   	       	GPIOB  
#define SHT2X_SCK_GPIO_RCC      			  RCC_APB2Periph_GPIOB  
 
#define SHT2X_DATA_PIN      					 	GPIO_Pin_11  
#define SHT2X_DATA_GPIO_PORT   	       	GPIOB  
#define SHT2X_DATA_GPIO_RCC      			  RCC_APB2Periph_GPIOB  

#define SHT2X_SCK_H         	  GPIO_SetBits(SHT2X_SCK_GPIO_PORT , SHT2X_SCK_PIN)   /*GPIOB->BSRR = GPIO_Pin_6*/
#define SHT2X_SCK_L             GPIO_ResetBits(SHT2X_SCK_GPIO_PORT , SHT2X_SCK_PIN) /*GPIOB->BRR  = GPIO_Pin_6 */
   
#define SHT2X_DATA_H         	  GPIO_SetBits(SHT2X_DATA_GPIO_PORT , SHT2X_DATA_PIN)   /*GPIOB->BSRR = GPIO_Pin_7*/
#define SHT2X_DATA_L         	  GPIO_ResetBits(SHT2X_DATA_GPIO_PORT , SHT2X_DATA_PIN) /*GPIOB->BRR  = GPIO_Pin_7*/

#define SHT2X_SCK_read()        	GPIO_ReadInputDataBit(SHT2X_SCK_GPIO_PORT , SHT2X_SCK_PIN)/* GPIOB->IDR  & GPIO_Pin_6   */
#define SHT2X_DATA_read()       	GPIO_ReadInputDataBit(SHT2X_DATA_GPIO_PORT , SHT2X_DATA_PIN)/*GPIOB->IDR  & GPIO_Pin_7	  */
