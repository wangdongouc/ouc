...
{
	 OLED_DispStr(10, 30, "    年  月  日", &tFont12);
	 OLED_DispStr(10, 45, "  时  分  秒", &tFont12);
}
...
void Time_Display(void)
{
	...
	sprintf((char*)buf,"  %02d-%02d %02d:%02d:%02d",time.tm_mon,time.tm_mday,time.tm_hour,time.tm_min,time.tm_sec);
	OLED_DispStr(0, 30,(char*)buf, &tFont12);
	
//	 printf("Time: %d-%d-%d   %02d:%02d:%02d \r\n", time.tm_year, \
//									 time.tm_mon+1, time.tm_mday,\
//									 time.tm_hour, time.tm_min, time.tm_sec);
//	OLED_DisDigital(10, 30,time.tm_year, &tFont12);//显示年
//	if((time.tm_mon+1)==1 && time.tm_mday==1 && time.tm_hour == 0 && time.tm_min == 0 && time.tm_sec == 0)
//	{
//		 OLED_DispStr(55, 30,"  ", &tFont12);
//	}
//	OLED_DisDigital(55, 30,(time.tm_mon+1), &tFont12);//显示月
//	
//	if(time.tm_mday==1 && time.tm_hour == 0 && time.tm_min == 0 && time.tm_sec == 0)
//	{
//		 OLED_DispStr(78, 30,"  ", &tFont12);
//	}
//	OLED_DisDigital(78, 30,time.tm_mday, &tFont12);//显示日
//	
//	if(time.tm_hour == 0 && time.tm_min == 0 && time.tm_sec == 0)
//	{
//		 OLED_DispStr(10, 45,"  ", &tFont12);
//	}
//	OLED_DisDigital(10, 45,time.tm_hour, &tFont12);//显示时
//	
//	if(time.tm_min == 0 && time.tm_sec == 0)
//	{
//		 OLED_DispStr(37, 45,"  ", &tFont12);
//	}
//	OLED_DisDigital(37, 45,time.tm_min, &tFont12);//显示分
//	
//	if(time.tm_sec == 0)
//	{
//		 OLED_DispStr(63, 45,"  ", &tFont12);
//	}
//	OLED_DisDigital(63, 45,time.tm_sec, &tFont12);//显示秒
}
